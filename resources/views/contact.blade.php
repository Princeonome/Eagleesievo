...
@section('content')
		...
		<div class="main"  data-bs-spy="scroll" data-bs-target="#navContentmenu" data-bs-root-margin="0px 0px -50%" data-bs-smooth-scroll="true">
							...
							<div class="about-content-wrapper position-relative">
								<div class="about-image-1 position-relative">
									<div class="about-image-wrapper">
										<img src="https://themeperch.net/html/eventiva/assets/images/home-1/about-image-1.jpg" class="img-fluid" alt="img">
									</div>
			...
			<!--Direction Section ======================-->
			<section id="direction" class="direction-section direction-1 position-relative pt-50 pt-lg-100 pt-xxl-130 pb-20 pb-lg-50">				
				<div class="container">
